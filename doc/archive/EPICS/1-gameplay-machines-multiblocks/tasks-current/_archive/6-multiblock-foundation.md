...
**Layer**: 2
**Status**: 🟡 **Foundation laid** — `managed_externally` flag, `onMachineCreated` callback, routing to reciped via `world.block_entity.update`. Full L2 gameplay (pattern detection wiring, SpatialIndex, persistence) deferred.
