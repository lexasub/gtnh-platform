...
struct ItemDefinition {
    ...
    ItemDefinition(uint16_t id_, const std::string& name_, uint8_t max_stack, uint16_t meta)
...
private:
    ...
    bool parseCSVLine(const std::string& line, std::string& idStr, std::string& nameStr,
                      std::string& stackStr, std::string& metaStr) const;
