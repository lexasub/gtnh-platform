...
#include <game/ui/client/UIDefaults.h>
#include <game/ui/client/BlockUIFactory.h>
#include <game/ui/client/player/PlayerInventory.h>
#include <game/ui/client/player/CreativeMenu.h>
...
bool GameClient::Init(const std::string& shaderDir, int width, int height,
    ...
    // ── Machine registry — load from machines.yaml ───────────────────────
    {
        ...
        if (!yaml_path) yaml_path = "src/content/data/registry/machines.yaml";
