...
static constexpr uint16_t kOreBlocks[] = {
    content::kOreIron, content::kOreGold, content::kOreTin, content::kOreCopper, content::kOreUranium, content::kOreQuartz,
    content::kOreCoal, content::kOreRedstone, content::kOreLapis, content::kOreDiamond, content::kOreElectrum
};
...
uint16_t DrillSystem::oreToDrop(uint16_t oreBlockId) {
    auto& table = content::oreDropTable();
    auto it = table.find(oreBlockId);
