...
private:
    ...
    void onReadPayload(std::error_code ec, std::shared_ptr<asio::ip::tcp::socket> socket,
    ...
    void doReadPayload(std::shared_ptr<asio::ip::tcp::socket> socket, uint32_t msg_size);
    ...
    void sendError(std::shared_ptr<asio::ip::tcp::socket> socket,
