...
namespace renderlib {
    ...
    public:
        ...
        // Вызывает callback для каждого видимого меша (фрустум во view space или world space – определим позже)
        virtual void ForEachVisibleMesh(const Frustum& frustum,
