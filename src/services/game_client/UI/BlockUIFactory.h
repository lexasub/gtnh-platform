...
// Machines are now resolved at runtime via MachineRegistry instead of compile-time
// enum entries.
//
// Example:
...
public:
    ...
    static IUIWindow* FindOrCreateMachine(UIManager& mgr, BlockPos pos, uint16_t type);
