...
public:
  ...
  virtual bool OnMouseClick([[maybe_unused]] int button,
  ...
  // msgType matches GatewayMsg constants (kInventoryUpdate,
  // kBlockEntityUpdate…).
  virtual void OnNetworkUpdate([[maybe_unused]] uint8_t msgType,
                               [[maybe_unused]] const void *data) {}

  // ── Factory hint ──────────────────────────────────────────────────────────
  // Returns true for windows tied to a world block (workbench, machine,
  // chest…).
