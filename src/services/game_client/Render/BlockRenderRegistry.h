...
inline PipeType blockIdToPipeType(uint16_t blockId) {
    switch (blockId) {
        case 61: return PipeType::FLUID_PIPE;
        case 62: return PipeType::ITEM_PIPE;
        case 64: return PipeType::DENSE_ITEM_PIPE;
        case 65: return PipeType::DENSE_FLUID_PIPE;
        default: return PipeType::ITEM_PIPE;  // fallback
    }
}
