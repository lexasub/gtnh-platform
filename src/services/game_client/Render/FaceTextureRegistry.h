...
inline uint16_t getFaceTexture(uint8_t role) {
    switch (role) {
        case 0: return TEXTURE_FACE_INPUT;
        case 1: return TEXTURE_FACE_OUTPUT;
        case 2: return TEXTURE_FACE_ENERGY;
        case 3: return TEXTURE_FACE_FLUID_IN;
        case 4: return TEXTURE_FACE_FLUID_OUT;
        case 5: return TEXTURE_FACE_DEFAULT;
        case 6: return TEXTURE_FACE_NONE;
        default: return TEXTURE_FACE_DEFAULT;
    }
}
