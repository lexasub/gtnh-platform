...
// ── ClientRecipeDB ─────────────────────────────────────────────────────────────
// Embedded crafting recipes for client-side preview.
// Each Recipe entry: { {slot0, slot1, ..., slot8}, {output_item_id, output_count} }
// slot = 0 means empty; item_id = 0 means empty slot
namespace Crafting {
...
constexpr Recipe kRecipes[] = {
    // minecraft:crafting_table (planks)
    // slot mapping: 13=top-left, 32=stick
    { { { {13, 1}, {13, 1}, {}, {13, 1}, {13, 1}, {}, {}, {}, {} } }, {14, 1} },

    // minecraft:crafting_table_cobblestone
    { { { {7, 1}, {7, 1}, {}, {7, 1}, {7, 1}, {}, {}, {}, {} } }, {14, 1} },

    // minecraft:crafting_table_iron
    ...
    { { { {7, 1}, {7, 1}, {7, 1}, {7, 1}, {}, {7, 1}, {7, 1}, {7, 1}, {7, 1} } }, {36, 1} },

    // minecraft:chest
    // planks: top row (4), middle (3), right-bottom (1)
    { { { {13, 1}, {13, 1}, {13, 1}, {13, 1}, {}, {13, 1}, {13, 1}, {13, 1}, {13, 1} } }, {37, 1} },
