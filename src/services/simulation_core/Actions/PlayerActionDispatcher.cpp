...
PlayerActionDispatcher::PlayerActionDispatcher(ItemGiveCallback onGiveItem)
    : onGiveItem_(std::move(onGiveItem))
{}

bool PlayerActionDispatcher::tryParseAsPlayerAction(
    const std::vector<uint8_t>& data, flatbuffers::Verifier& verifier) {
...
void PlayerActionDispatcher::dispatch(const std::vector<uint8_t>& data) {
