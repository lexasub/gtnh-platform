...
public:
  ...
  virtual void publishNodeUpdate(uint64_t node_id, int32_t x, int32_t y, int32_t z,
  ...
  virtual void sendFluidRequest(uint64_t node_id, int32_t x, int32_t y, int32_t z,
