...
NOTE: Core implementation (G key binding + raycast + face detection + SendToolAction) already exists in `InteractionSystem.cpp:76-98`. Remaining gaps: itemId not sent, no wrench-in-hand filter, no ToolActionResp handler.
