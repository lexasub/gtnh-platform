...
- [x] 1.8 `data/quests/quests.csv` — 38 quests across 4 eras with detection types + rewards
- [x] 1.9 `data/quests/quest_graph.json` — DAG edges for all 38 quests
...
- [x] 7.1 38 quest definitions in `data/quests/quests.csv`
...
src/libs/quest_lib/QuestData.cpp                — 248 lines
...
data/quests/quests.csv                          — 39 lines (38 quests)
data/quests/quest_graph.json                    — 42 lines (38 nodes)
...
src/services/simulation_core/Quest/QuestManager.cpp     — 320 lines
