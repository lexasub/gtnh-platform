...
- [ ] 2.1 Advertise the LCR's legacy EU node at its physical ENERGY hatch position.
...
- [ ] 3.2 Place multiple generators, boilers, fluid pipes, turbines, LV battery buffers, cables, and an LCR with canonical item/fluid/energy hatches.
- [ ] 3.3 Insert fuel, rechargeable cells, and recipe inputs; assert every placement/slot response.
- [ ] 3.4 Assert LCR formation event, physical energy hatch, steam/EU/battery transitions, and recipe progress/output.
...
- [ ] 4.1 Keep the existing direct thermal-chain test green.
